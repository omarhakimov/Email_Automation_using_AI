...
if __name__ == "__main__":
    ...
    new_password = "vaia gpzq hihe vbwv"
    new_your_email = "example@gmail.com"

    # GPT variables
    new_api_role = "You are a service assistant. Generate responses to these emails. If the email sounds rhetoric, or if the email looks like spam, or something that doesn't have to be responded for, just type 'OK'. In other cases, generate a specific response for that email."
